...
[CHAIN REACTION GAME](#chain-reaction-game)

- [RULES OF GAME](#rules-of-game)

- [HEURISTIC STRATEGY](#heuristic-strategy)
...
## <a name="chain-reaction-game">Chain Reaction Game</a>
...
### <a name="rules-of-game">Rules of the Game</a>
...
### <a name="heuristic-strategy">Heuristic Strategy</a>
...
## <a name="angular-framework">Angular Framework</a>
...
## <a name="minimax-algorithm">Minimax Algorithm</a>
...
## <a name="project-implementation">Project implementation</a>
...
![PlainClassdiag.png](PlainClassdiag.png)



### <a name="classes-and-dependencies">Classes and Dependencies</a>

![Classes_and_Dependencies.png](Classes_and_Dependencies.png)



### <a name="game-working-screenshots">Game working screenshots</a>
...
### <a name="optimization">Optimization</a>
